...
app.post('/query', (req, res, next) => {
  ...
  const traversal = req.body.traversal;

  const client = new gremlin.driver.Client(`ws://${gremlinHost}:${gremlinPort}/gremlin`, { traversalSource: traversal, mimeType: 'application/json' });
